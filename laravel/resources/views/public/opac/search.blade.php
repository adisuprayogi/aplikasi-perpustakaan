...
<div class="mb-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('opac.advanced') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition">
    ...
    <div class="flex flex-wrap gap-2 mb-4">
        ...
        @endif
        <a href="{{ route('opac.search', ['q' => $query]) }}" class="inline-flex items-center px-3 py-1 bg-gray-200 text-gray-700 text-sm rounded-full hover:bg-gray-300">
...
<div class="flex gap-6">
    ...
    <div class="flex-1">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <a href="{{ route('opac.show', $collection->id) }}" class="block bg-white rounded-lg shadow-sm p-4 hover:shadow-md transition">
                <div class="flex">
                    <!-- Cover -->
                    ...
                    @else
                    <div class="w-24 h-32 bg-gradient-to-br from-blue-100 to-blue-50 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-lg font-medium text-gray-900 hover:text-blue-700 transition">{{ $collection->title }}</h3>
                        ...
                        <p class="text-sm text-gray-500 mt-2 line-clamp-2">{{ $collection->abstract }}</p>
                        @endif
        ...
        <div class="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <a href="{{ route('opac.search') }}" class="inline-flex items-center px-4 py-2 bg-blue-800 hover:bg-blue-900 text-white text-sm font-medium rounded-lg transition">
                Reset Pencarian
            </a>
        </div>
        @endif
