...
<div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
    <a href="{{ route('reservations.index') }}" class="group relative overflow-hidden @if(request('status') == '') bg-gradient-to-br from-blue-500 to-blue-600 @else bg-white border border-gray-100 @endif rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300">
    ...
    <a href="{{ route('reservations.index', ['status' => 'pending']) }}" class="group relative overflow-hidden @if(request('status') == 'pending') bg-gradient-to-br from-amber-500 to-yellow-500 @else bg-white border border-gray-100 @endif rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300">
        <div class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500"></div>
        <div class="relative">
    ...
    <a href="{{ route('reservations.index', ['status' => 'ready']) }}" class="group relative overflow-hidden @if(request('status') == 'ready') bg-gradient-to-br from-emerald-500 to-green-500 @else bg-white border border-gray-100 @endif rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300">
        <div class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500"></div>
        <div class="relative">
    ...
    <a href="{{ route('reservations.index', ['status' => 'fulfilled']) }}" class="group relative overflow-hidden @if(request('status') == 'fulfilled') bg-gradient-to-br from-blue-500 to-indigo-500 @else bg-white border border-gray-100 @endif rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300">
        <div class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500"></div>
        <div class="relative">
    ...
    <a href="{{ route('reservations.index', ['status' => 'cancelled']) }}" class="group relative overflow-hidden @if(request('status') == 'cancelled') bg-gradient-to-br from-gray-500 to-gray-600 @else bg-white border border-gray-100 @endif rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300">
        <div class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500"></div>
        <div class="relative">
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
    <form method="GET" action="{{ route('reservations.index') }}" class="flex gap-4">
        <div class="flex-1">
            <div class="relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama anggota / barcode / judul..."
                    class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-600/20 focus:border-amber-600 transition">
            </div>
        </div>
        ...
        <a href="{{ route('reservations.index') }}" class="px-5 py-2.5 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-xl transition font-medium">
            Reset
        </a>
        @endif
    </form>
