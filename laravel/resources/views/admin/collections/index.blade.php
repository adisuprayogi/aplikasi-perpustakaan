...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
    <form method="GET" action="{{ route('collections.index') }}" class="flex flex-wrap gap-4">
        ...
        <div>
            ...
            <select name="collection_type_id" class="px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition min-w-[150px]">
        ...
        <div class="flex items-end">
            <label class="flex items-center px-4 py-2.5 bg-gray-50 rounded-xl border border-gray-200 cursor-pointer hover:bg-gray-100 transition">
                ...
                <span class="ml-2 text-sm text-gray-700">Hanya tersedia</span>
            </label>
        </div>
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('collections.index') }}" class="px-5 py-2.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition font-medium">
                Reset
            </a>
            @endif
        </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="p-5">
            ...
            <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('collections.show', $collection) }}" class="text-blue-600 hover:text-blue-900 font-medium text-sm">Lihat</a>
                    @endcan
                    @can('collections.edit')
                    <a href="{{ route('collections.edit', $collection) }}" class="text-blue-600 hover:text-blue-900 font-medium text-sm">Edit</a>
                    @endcan
                </div>
            </div>
        </div>
    ...
    <div class="col-span-full py-12 text-center">
        ...
        <p class="text-sm text-gray-500">Belum ada data koleksi.</p>
    </div>
    @endforelse
</div>
