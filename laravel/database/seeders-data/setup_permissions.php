...
/**
 * ============================================
 * COMPLETE SETUP SCRIPT FOR SERVER
 * Aplikasi Perpustakaan Digital
 * ============================================
 *
 * Run this script via: php artisan setup:permissions
 * OR: php artisan tinker --exec="require 'database/seeders-data/setup_permissions.php';"
 */
...
echo "===========================================\n";
echo "  SETUP ROLES & PERMISSIONS\n";
echo "===========================================\n\n";

// Step 1: Create Permissions
echo "Step 1: Creating 77 permissions...\n";
$permissions = [
...
echo "  ✓ super_admin: 77 permissions\n";

// admin - ALL permissions (same as super_admin)
$admin = Role::where('name', 'admin')->first();
$admin->syncPermissions(Permission::all());
echo "  ✓ admin: 77 permissions\n";
...
echo "  ✓ branch_admin: " . count($branchAdminPerms) . " permissions\n";
...
echo "  ✓ circulation_staff: " . count($circulationPerms) . " permissions\n";
...
echo "  ✓ catalog_staff: " . count($catalogPerms) . " permissions\n";
...
echo "  ✓ report_viewer: " . count($reportPerms) . " permissions\n";
...
echo "  ✓ member: " . count($memberPerms) . " permissions\n\n";
